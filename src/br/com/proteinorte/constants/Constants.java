...
public final class Constants {
    ...
    public static String ScripSelectHeader() throws Exception {
        ...
        stringBuilder.append("SELECT CAB.NUMNOTA,").append(" ")
                ...
                .append("PAR.RAZAOSOCIAL AS NOMEPARC,").append(" ")
                ...
                .append("(SELECT MIN(CASE TIT.CODTIPTIT WHEN 2 THEN 'A' ELSE 'B' END)").append(" ")
                .append("FROM TGFFIN FIN").append(" ")
                .append("INNER JOIN TGFTIT TIT ON TIT.CODTIPTIT = FIN.CODTIPTIT").append(" ")
                .append("WHERE FIN.NUNOTA = CAB.NUNOTA) AS FORMAPAGAMENTO").append(" ")
