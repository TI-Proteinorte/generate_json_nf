...
public final class Constants {
    ...
    public static String ScripSelectHeader() throws Exception {
        ...
        stringBuilder.append("SELECT CAB.NUMNOTA,").append(" ")
                ...
                .append("CASE TIT.CODTIPTIT WHEN 2 THEN 'A' ELSE 'B' END FORMAPAGAMENTO").append(" ")
                ...
                .append("LEFT JOIN TGFFIN FIN ON FIN.NUNOTA = CAB.NUNOTA").append(" ")
                .append("LEFT JOIN TGFTIT TIT ON TIT.CODTIPTIT = FIN.CODTIPTIT").append(" ")
